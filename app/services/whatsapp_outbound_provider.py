...
class MetaWhatsAppOutboundProvider:
    ...
    def send_text_message(self, *, recipient_phone: str, text: str) -> NotificationResult:
        ...
        try:
            result = self._send_runner(self._outbound_service.send_text_message(recipient_phone=recipient_phone, text=text))
        except Exception:
            return NotificationResult(status="failed", reason="provider_error")
